...
export function HomeBadge(props: HomeBadgeProps) {
  ...
  return (
    <motion.div
      ...
      className="hover:border-blue-400 border-transparent rounded-xl px-[12px] py-[10px] hover:cursor-pointer border-2 bg-blue-100 flex gap-2 group md:mt-0 mt-4 justify-between"
    >
