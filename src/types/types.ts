import type { Attribute, Common, Utils, Schema } from "@strapi/strapi";
...
type RelationValue<TAttribute extends Attribute.Attribute> =
  ...
  >
    ? Utils.MatchFirst<
        [
          [
            Utils.Extends<TRelationKind, Attribute.RelationKind.WithTarget>,
...
export type GetValue<TAttribute extends Attribute.Attribute> = Utils.If<
  Utils.IsNotNever<TAttribute>,
  Utils.MatchFirst<
    [
      // Relation
      [
        Utils.Extends<TAttribute, Attribute.OfType<"relation">>,
        RelationValue<TAttribute>,
      ],
      // DynamicZone
      [
        Utils.Extends<TAttribute, Attribute.OfType<"dynamiczone">>,
        DynamicZoneValue<TAttribute>,
      ],
      // Component
      [
        Utils.Extends<TAttribute, Attribute.OfType<"component">>,
        ComponentValue<TAttribute>,
      ],
      // Media
      [
        Utils.Extends<TAttribute, Attribute.OfType<"media">>,
      ...
      [Utils, Attribute.GetValue<TAttribute, unknown>],
    ],
    unknown
  >,
  unknown
